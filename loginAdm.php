...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("ss", $usernameAdm, $passwordAdm); // Bind parameters
    $stmt->execute();
    ...
    <div class="container">
        ...
        <form id="loginForm" method="POST"> <!--method POST should include-->
            ...
            <div class="form-group">
                ...
                <input type="text" id="admUsername" name="admUsername" maxlength="20" autofocus required> 
            ...
            <div class="form-group">
                ...
                <input type="password" id="admPwd" name="admPwd" maxlength="16" required>
            </div>
        ...
        <div class="links">
            <a href="registerAdm.php" class="otherOption">Register New Account</a>
            <div class="vl"></div> <!--A vertical line styled as a divider between the links.-->
            <a href="forgotAdm.php" class="otherOption">Forgot Password?</a>
        </div>
    </div>
    ...
    <script>
        ...
        .then(data => {
            if (data.trim() === "success") {
                // Handle success
                messageDiv.textContent = "Dear administrator, login successful!";
                messageDiv.style.color = "green";
                //
                setTimeout(() => {
                    window.location.href = "homePageAdm.php"; // Redirect to next page
